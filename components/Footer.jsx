...
const Footer = () => (
  ...
  >
    ...
    <div className={`${styles.innerWidth} flex flex-col mx-auto gap-8`}>
      <div className="flex items-center justify-between gap-5 felx-wrap">
        <h4 className="font-bold md:text-[64px] text-[44px] text-white ">
          Enter the Metaverse{" "}
        </h4>
        <button
          type="button"
          className="flex items-center h-fit py-4 px-6 bg-cyan-600 rounded-[32px] gap-[12px] "
        >
          <img
            src="/headset.svg"
            alt="headset"
          ...
          />
          <span className="font-normal uppercase text-[16px] text-white">
            Enter Metaverse
          </span>
        </button>
      </div>
